            ...
            {chatHistory
              ...
              .map((chat, chatIndex) =>
                chat.messages.map((msg, msgIndex) => (
                  ...
                  >
                    {msg.sender === "User" ? <FaUserCircle className="text-[20px] cursor-pointer mt-2"/> : <img src={personal_ai_doctor} alt="img" className="w-7 h-7" />}{msg.message}
                    {msg.fileUrl && (
                      <div>
